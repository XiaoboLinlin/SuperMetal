...
def parse_train_args():
    ...
    parser.add_argument('--project', type=str, default='DiffMetal_diverse', help='')
    ...
    parser.add_argument('--use_metal_featurizer', action='store_true', help='If properly featurize metals')
