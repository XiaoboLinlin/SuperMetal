...
parser.add_argument('--out_file', type=str, default="data/prepared_for_esm_metal_cleaned.fasta")
# parser.add_argument('--dataset', type=str, default="metalbind")
parser.add_argument('--data_dir', type=str, default='data/zincbind_cleaned_processed/', help='')
